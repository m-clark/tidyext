...
#' @description  This function extends gather to work on multiple sets of columns.
#' @param data A data frame.
#' @param key See \code{\link[tidyr]{gather}}.
#' @param values Multiple values. \code{\link[tidyr]{gather}}.
#' @param varlist A list with elements that are created with \code{\link[dplyr]{vars}}.  See
#'   details.
#' @param ... See \code{\link[tidyr]{gather}}.
#' @param na.rm For this to work it makes no sense to set this to true. See
