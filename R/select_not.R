...
#'
#'   \code{data \%>\%} \cr
#'   \Sexpr{"\u200B"} \Sexpr{"\u200B"} \code{select(-one_of(not_these))}
#'
...
#'   developer at RStudio, so one can assume it's a fairly spot on suggestion.
...
#'   approach.
#'
#'   \code{x = vars_input \%>\%} \cr
#'   \Sexpr{"\u200B"} \Sexpr{"\u200B"}  \code{map(function(sym) call("-", sym)) }\cr
#'   \cr
#'   \code{data \%>\%} \cr
#'   \Sexpr{"\u200B"} \Sexpr{"\u200B"}  \code{select(!!!x)}
#'
