...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/m-clark/tidyext?branch=master&svg=true)](https://ci.appveyor.com/project/m-clark/tidyext)
...
The usual GitHub installation via the <span class="pack">devtools</span> package.
